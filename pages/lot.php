<?php 
  ...
  if(!preg_match('#^[0-9]+$#', $prod)) {
    $msg = "Не корректный ID лота";
    http_response_code(404);
    exit();
  }
  if(count($arr_prod) < $prod || $prod < 0) {
    $msg = "Такого лота не существует";
    header('Location: ../index.php');
  } else {
    $product = $arr_prod[$prod];
  }
  echo $msg;
?>
<!DOCTYPE html>
  ...
  <section class="lot-item container">
    ...
    <div class="lot-item__content">
      <div class="lot-item__left">
        ...
        <p class="lot-item__category">Категория: <span><?=$product['Категория']; ?></span></p>
        ...
        <div class="lot-item__state">
          ...
          <div class="lot-item__cost-state">
            <div class="lot-item__rate">
              ...
              <span class="lot-item__cost"><?=$product['Цена']; ?></span>
            </div>
